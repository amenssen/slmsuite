"""
Bare bones wrapper for Instrumental cameras.
...
References
----------
.. [1] https://instrumental-lib.readthedocs.io/en/stable/install.html
"""
...
try:
    ...
    print("instrumental.py: instrumental not installed. Install to use Instrumental cameras.")
...
class Instrumental(Camera):
    ...
    def close(self):
        ...
        """
        raise RuntimeError(
            "The user must close the instrumental camera separately,"
            "as it was constructed outside this wrapper."
        )
    ...
    def info(verbose=True):
        ...
        """
        raise RuntimeError(
            ".info() is not applicable to instrumetal cameras which are"
